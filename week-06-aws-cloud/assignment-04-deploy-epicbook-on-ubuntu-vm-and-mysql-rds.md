...
![Week 06 Screenshots](screenshots/week-06-screenshots-10.png)

---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![Week 06 Screenshots](screenshots/week-06-screenshots-11.png)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![Week 06 Screenshots](screenshots/week-06-screenshots-12.png)
...
![Week 06 Screenshots](screenshots/week-06-screenshots-13.png)

---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![Week 06 Screenshots](screenshots/week-06-screenshots-14.png)
...
![Week 06 Screenshots](screenshots/week-06-screenshots-15.png)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![Week 06 Screenshots](screenshots/week-06-screenshots-16.png)
...
![Week 06 Screenshots](screenshots/week-06-screenshots-17.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![Week 06 Screenshots](screenshots/week-06-screenshots-18.png)

---

#### Screenshot 10 — Output of `mysql --version`

![Week 06 Screenshots](screenshots/week-06-screenshots-19.png)
...
![Week 06 Screenshots](screenshots/week-06-screenshots-20.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![Week 06 Screenshots](screenshots/week-06-screenshots-21.png)
...
![Week 06 Screenshots](screenshots/week-06-screenshots-22.png)
...
![Week 06 Screenshots](screenshots/week-06-screenshots-26.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![Week 06 Screenshots](screenshots/week-06-screenshots-27.png)
